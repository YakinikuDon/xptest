...
const questions = [
    ...
    },
    {
        ...
        options: [
            ...
            { text: "表面不爽，但其实心里有一丝丝诡异的爽感，甚至想多跪一会儿。", dom: -1, mental: -1, hardcore: 1, order: 1 },
    ...
    {
        q: "参加抽奖中了一个“霸道总裁/冷酷御姐”，你会让ta为你做什么？",
        options: [
            { text: "穿上西装给我念检讨书，错一个字扣一块钱工资。", dom: 1, mental: 1, hardcore: -1, order: 1 },
            { text: "把ta绑在椅子上，看着我吃掉最后一块炸鸡。", dom: 1, mental: -1, hardcore: -1, order: 1 },
            { text: "什么都不用做，就用那种看垃圾一样的眼神盯着我就行了。", dom: -1, mental: 1, hardcore: 1, order: -1 },
            { text: "让ta把我当抱枕，24小时挂在ta身上吸取人类精华。", dom: -1, mental: -1, hardcore: -1, order: -1 }
        ]
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            { text: "“你真是个一无是处的废物，离了我你可怎么活啊。”", dom: -1, mental: 1, hardcore: 1, order: -1 },
    ...
    },
    {
        ...
        options: [
            ...
            { text: "跟着大家一起哈哈哈，觉得无所谓，甚至想上去给他一个抱抱。", dom: -1, mental: -1, hardcore: -1, order: -1 }
        ]
    },
    {
        ...
        options: [
            ...
            { text: "唯唯诺诺不敢说话，并在脑内疯狂幻想自己被黑道大哥暴揍的场景以缓解焦虑。", dom: -1, mental: 1, hardcore: -1, order: -1 },
...
const typesData = {
    // Dom, Mental
    "1101": { letters: "TCHR", char: "教导官", desc: "纯纯的赛博班主任。平时人模狗样，一谈恋爱就喜欢布置作业。你根本不是在找对象，你是在收徒弟。看着对方战战兢兢地遵守你的破规矩，你心里那点隐秘的控制欲简直爽到升天。", play: "「赛博批改作业」让对方穿上正装大声朗读你撰写的恋爱家规，读错一个字加时罚站，并在脖子上盖“不合格”红章。", compatible: "优等生", bgPos: "0% 0%" },
    ...
    "1000": { letters: "HUNT", char: "猎手", desc: "人形二哈/精力过剩的原始人。你对复杂的心理战毫无兴趣，你只喜欢‘我追，你逃，你插翅难飞’。把你放出门你就是个疯子，但在绝对的暴力压制后，你偶尔也会撒个娇。", play: "「黑暗躲猫猫」关掉全屋的灯给对方三分钟藏好，抓到了直接就地正法；抓不到？这不可能，你早就把门反锁了。", compatible: "粘人精", bgPos: "33.333% 33.333%" },
    ...
    // Sub, Mental
    "0101": { letters: "STUD", char: "优等生", desc: "重度斯德哥尔摩/讨好型牛马。哪怕对方让你去西天取经，你也要先问一句‘师傅，要不要带特产？’。每天最大的XP就是被夸一句‘你真棒’，然后继续当牛做马。", play: "「五星好评服务」跪在床头拿小本本，严格按伴侣指示提供全方位按摩，完事卑微递上问卷：“主人，请问本次服务能给五星吗？”", compatible: "教导官", bgPos: "0% 66.666%" },
    "0100": { letters: "DREM", char: "幻想家", desc: "脑补帝/赛博受虐狂。每天在脑内模拟被八百壮士轮流支配的场景，但现实中连个瓶盖都拧不开。只要对方一句话，你就能在脑子里演完一部80集的虐恋连续剧。", play: "「赛博脑内高潮」不需要任何肢体接触，只需要伴侣发一条“洗干净等我”的微信，你就能在被窝里脑补出八万字小说把自己感动哭。", compatible: "谜语人", bgPos: "33.333% 66.666%" },
    ...
    "0011": { letters: "MONK", char: "苦行僧", desc: "痛觉收集癖/受苦艺术家。什么温存浪漫，对你来说都不如给你两鞭子来得实在。你需要极其繁复的受刑仪式来确认自己的存在，别人痛得嗷嗷叫，你在心里默默念大悲咒。", play: "「冰火两重天修道」拒绝温软的床铺，要求伴侣一边用冰块在你背上画画，一边用小皮鞭进行敲打，你在痛苦中感悟宇宙的真理。", compatible: "典狱长", bgPos: "66.666% 100%" },
